...
/**
 * Patch PivotController to add date range and numeric range search filters
 */
patch(PivotController.prototype, {
    ...
    /**
     * Initialize range filters by detecting date and numeric fields from pivot measures
     */
    _initRangeFilters() {
        ...
        // Get all fields from model metadata
    ...
    _buildRangeDomain() {
        ...
        if (this.dateRangeState.selectedDateField) {
            ...
            if (dateTo) {
                // For date fields, include the entire day by using <= with end of day
